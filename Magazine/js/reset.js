...
//Globals
let imageList = ['racing goggles', 'training goggles', 'racing cap','training cap', 'men jammer','men trunks','fina approved jammer',
    ' women one piece ','fina approved kneeskin','tech paddles','kickboard','flippers','pullbuoy','snorkel','mesh bag','backpack'];
